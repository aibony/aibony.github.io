...
Computed from the repository: 11,098+ commits, 951 Python modules, ~110,585 lines of code, 532 test files — all under a 2 GB VRAM ceiling.
...
**Services:** AI infrastructure design; governance frameworks for autonomous systems; local-first deployment for data-residency-constrained organisations; SWIFT / ISO 20022 / trade finance consulting.
